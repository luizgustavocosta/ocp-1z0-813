...
public class Q13 {
	...
	public static void main(String[] args) {
		...
		ConcurrentMap<Boolean, List<String>> data = 
				Stream.of(cats, bears).flatMap(s -> s)
				//.collect(Collectors.groupingByConcurrent(s-> !s.startsWith) The comparation is with Object 
				.collect(Collectors.groupingByConcurrent(s -> !s.toString().startsWith("p")));
